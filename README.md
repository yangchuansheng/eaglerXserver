...
```bash
docker pull ghcr.io/yangchuansheng/eaglerx1.8server:2.2.2

# Paper 1.12.2
docker run -d -p 5200:5200 \
  -e MINECRAFT_VERSION=1.12 \
  ghcr.io/yangchuansheng/eaglerx1.8server:2.2.2
...
```bash
gh workflow run release.yml -f release_tag=v2.2.2
```
